...
class Server {
    ...
    registerRender(suitePath) {
        if (this._lastSuitePath !== suitePath) {
            this._bundleTestFileForBrowser(suitePath);
            this._lastSuitePath = suitePath;
        }
        return this._urlBuilder.registerUrl();
    }

    _bundleTestFileForBrowser(suitePath) {
